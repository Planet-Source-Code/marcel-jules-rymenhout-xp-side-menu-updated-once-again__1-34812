...
Begin VB.UserControl XPsidemenu 
   ...
   ScaleHeight     =   9045
   ScaleWidth      =   7770
   ToolboxBitmap   =   "XPSIDEMENU.ctx":0000
   ...
   Begin VB.PictureBox piccontainer 
      ...
      Begin Project1.Header Header 
         ...
         _ExtentY        =   873
      End
      Begin Project1.Hholder Hholder 
         Height          =   30
         Index           =   0
         Left            =   480
         TabIndex        =   2
...
Private Sub Header_click(Index As Integer)
    ...
    Set pobj = Pcol(Index)
        ...
        If pobj.Psate = Opened Then
            ...
            pobj.Psate = Closed
           ' Hholder(Index).Height = 0
            For I = 1 To Hholder(Index).Height
                    Hholder(Index).Height = Hholder(Index).Height - ANISPEED
            Next I
